  ...
  <div>
    <div style="min-width:1000px">
      <Card shadow>
        ...
        <!--&lt;!&ndash;添加角色&ndash;&gt;-->
        <!--<Button v-if="buttonVerifAuthention('sys:markdown:add')" type="primary" icon="md-add" @click="addClick"-->
        <!--style="margin-bottom: 10px;">添加文章-->
        <!--</Button>-->
        ...
        >
          <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
            <FormItem label="文章标题" prop="roleName">
              <Input v-model.trim="formValidate.roleName" placeholder="请输入文章标题"></Input>
            </FormItem>
            <div>
            <mavon-editor
            v-model="content"
  ...
  export default {
    ...
    data() {
      return {
        ...
        ruleValidate: {
          roleName: [
            {required: true, message: '请选择标题名', trigger: 'blur'},
